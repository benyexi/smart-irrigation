import{a as e}from"./rolldown-runtime-COnpUsM8.js";import{g as t}from"./vendor-echarts-C1yMOKh3.js";import{At as n,Ct as r,D as i,E as a,It as o,Q as s,Y as c}from"./useSize-DQD0UnLs.js";var l=e(t());function u(e){return e.replace(/-(.)/g,(e,t)=>t.toUpperCase())}function d(e,t){o(e,`[@ant-design/icons] ${t}`)}function f(e){return typeof e==`object`&&typeof e.name==`string`&&typeof e.theme==`string`&&(typeof e.icon==`object`||typeof e.icon==`function`)}function p(e={}){return Object.keys(e).reduce((t,n)=>{let r=e[n];switch(n){case`class`:t.className=r,delete t.class;break;default:delete t[n],t[u(n)]=r}return t},{})}function m(e,t,n){return n?l.createElement(e.tag,{key:t,...p(e.attrs),...n},(e.children||[]).map((n,r)=>m(n,`${t}-${e.tag}-${r}`))):l.createElement(e.tag,{key:t,...p(e.attrs)},(e.children||[]).map((n,r)=>m(n,`${t}-${e.tag}-${r}`)))}function h(e){return s(e)[0]}function g(e){return e?Array.isArray(e)?e:[e]:[]}var _=`
.anticon {
  display: inline-flex;
  align-items: center;
  color: inherit;
